...
fig.update_traces(textfont_size=18,
                  ...
                  textfont_family="Courier New Bold")
...
fig.update_layout(barmode='group', xaxis_type='category', legend_orientation="h",
...
fig.update_layout(barmode='stack', xaxis_type='category', #legend_orientation="h",
                   title='<b></b><b>Depósitos Garantizados / Depósitos del Público </b><br><i>Porcentajes</i>',
                  #"",
...
values1 = [62.4, 37.6] #Diciembre 2019
 ...
 #       ),
       annotations=[
        dict(
            ...
            dict(text='Depósitos Garantizados por Tipos de Moneda', x=0.97, y=1.2, font_size=22, showarrow=False),
